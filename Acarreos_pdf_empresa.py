...
class Imprime_Pdf_Empresa():
    ...
    def exportar_a_pdf(data):
        ...
        content = []
        title = Paragraph("REPORTE ACARREOS POR EMPRESA", styles['Title'])
    ...
    def main_pdf_empresa(empresa1):
        ...
        with tab1:
            ...
            try:
                ...
                df = pd.read_sql_query(f"SELECT * FROM datos_acarreo WHERE datos_acarreo.contratista = '{empresa1}'", conn)
                st.dataframe(df)
        ...
        with tab2:
            ...
            try:
                ...
                cursor.execute(f"SELECT * FROM datos_acarreo WHERE contratista = '{empresa1}'")
                ...
                pdf_buffer = Imprime_Pdf_Empresa.exportar_a_pdf(data)
                
                st.download_button(
                    label="Descargar Reporte PDF",
                    data=pdf_buffer,
                    file_name="Reporte_Empresa.pdf",
                    mime="app")
