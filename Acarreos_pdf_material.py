...
class Imprime_Pdf_Material():
    ...
    def exportar_a_pdf(data):
        ...
        content = []
        title = Paragraph("REPORTE ACARREOS POR MATERIAL", styles['Title'])
    ...
    def main_pdf_material(material1):
        ...
        with tab1:
            ...
            try:
                ...
                df = pd.read_sql_query(f"SELECT * FROM datos_acarreo WHERE datos_acarreo.material = '{material1}'", conn)
                st.dataframe(df)
        ...
        with tab2:
            ...
            try:
                ...
                cursor.execute(f"SELECT * FROM datos_acarreo WHERE material = '{material1}'")
                ...
                pdf_buffer = Imprime_Pdf_Material.exportar_a_pdf(data)
                
                st.download_button(
                    label="Descargar Reporte PDF",
                    data=pdf_buffer,
                    file_name="Reporte_Material.pdf",
                    mime="app")
