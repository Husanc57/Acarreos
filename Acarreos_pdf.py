...
class Imprime_Pdf():
    ...
    def exportar_a_pdf(data):
        ...
        content = []
        title = Paragraph("REPORTE DE ACARREOS GENERAL", styles['Title'])
    ...
    def main_pdf():
        ...
        with tab1:
            ...
            try:
                ...
                df = pd.read_sql_query("SELECT * FROM datos_acarreo", conn)
                st.dataframe(df)
        ...
        with tab2:
            ...
            if st.button("Generar Reporte PDF"):
                try:
                    ...
                    cursor.execute("SELECT * FROM datos_acarreo")
                    ...
                    pdf_buffer = Imprime_Pdf.exportar_a_pdf(data)
                
                    st.download_button(
                        label="Descargar Reporte PDF",
                        data=pdf_buffer,
                        file_name="Reporte_Acarreos_General.pdf",
        ...
        with tab3:
            ...
            try:
                ...
                with col2:
                    st.metric("Costo Total", f"Ȼ{df['monto'].sum():.2f}")
