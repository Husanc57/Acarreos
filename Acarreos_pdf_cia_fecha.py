...
class Imprime_Pdf_Cia_Fecha():
    ...
    def exportar_a_pdf(data):
        ...
        content = []
        title = Paragraph("REPORTE ACARREOS POR EMPRESA y FECHA", styles['Title'])
    ...
    def main_pdf_cia_fecha(contratista1, fecha1):
        ...
        with tab1:
            ...
            try:
                ...
                df = pd.read_sql_query(f"SELECT * FROM datos_acarreo WHERE contratista = '{contratista1}' AND fecha = '{fecha1}'", conn)
                st.dataframe(df)
        ...
        with tab2:
            ...
            if st.button("Generar Reporte PDF"):
                try:
                    ...
                    cursor.execute(f"SELECT * FROM datos_acarreo WHERE contratista = '{contratista1}' AND fecha = '{fecha1}'")
                    ...
                    pdf_buffer = Imprime_Pdf_Cia_Fecha.exportar_a_pdf(data)
...
if __name__ == "__main__":
    Imprime_Pdf_Fecha.main_pdf_fecha()
